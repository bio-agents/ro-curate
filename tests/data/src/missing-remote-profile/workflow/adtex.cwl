...
requirements:
  - class: DockerRequirement
    dockerPull: "quay.io/ucsc_cgl/dockstore_agent_adtex:v1.0.0"

baseCommand: ['-o', './', '--tostdout']

doc: "Docker container for an ADTEx workflow. See the [github repo](https://github.com/BD2KGenomics/dockstore_agent_adtex.git) for more information."
